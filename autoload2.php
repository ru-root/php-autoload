...
class Autoloader
{
    ...
    private static ?Autoloader $anonymous = NULL;
    ...
    {
        if (is_null(static::$anonymous)) {
            static::$anonymous = new class extends Autoloader
            {
                ...
                protected static ?\Closure $include = NULL;
    ...
    {
        return static::$anonymous::findFiles(strtr($dir, '\\', DIRECTORY_SEPARATOR), $file, $ext, $array);
    }

    final public static function include(string $file, string $dir = '', array $data = [], string $ext = self::EXT): mixed
    {
        return is_file($file) || ($file = static::$anonymous::findFiles($dir, $file, $ext))
            ? (static::$anonymous::$include)($file, $data)
            : NULL;
    }
